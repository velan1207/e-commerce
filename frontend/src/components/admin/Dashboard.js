...
export default function Dashboard () {
    ...
    if (adminOrders.length > 0) {
     ...
     const { loading: productsLoading } = useSelector(state => state.productsState || {});
     const { loading: ordersLoading } = useSelector(state => state.orderState || {});
     const { loading: usersLoading } = useSelector(state => state.userState || {});
